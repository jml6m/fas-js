...
| `test/languages.spec.js` | Regular language definitions, operations, closure, NFA↔DFA (v1.5); `@theorem-implemented-test` golden fixtures for subset construction (see `docs/function-annotation-protocol.md`) |
