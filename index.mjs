  ...
  (0, _createClass2.default)(FSA, [{
      ...
      if (this.paths.size > 0) {
        ...
        try {
          for (var _iterator2 = this.paths[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            console.error(chalk.redBright("State %s on input(s): %s"), key.name, (0, _toConsumableArray2.default)(val).join(" "));
          }
        } catch (err) {
          _didIteratorError2 = true;
          _iteratorError2 = err;
    ...
    value: function determineStateOrder() {
      ...
      if (deadStates.length > 0) {
        console.warn(chalk.yellowBright("Dead states detected, removing them and associated transitions: %O"), deadStates);
...
var simulateFSA = function simulateFSA(w, fsa) {
  ...
  if (logging) console.log(chalk.cyan("Beginning FSA Simulation")); //Accept either string or string[] for w
